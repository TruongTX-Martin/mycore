...
public class Constant {
	...
	public static final String SITE_NHAC_CUA_TUI = "nhaccuatui.com";
	public static final String SITE_KEENG_VN = "keeng.vn";
	public static final String SITE_NHAC_SO_NET	 = "nhacso.net";
