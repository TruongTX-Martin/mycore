package com.iphonmusic.style.floatingbutton;
...
//  }
  ...
  private void createAddButton(Context context) {
    mAddButton = new AddFloatingActionButton(context) {
      ...
      Drawable getIconDrawable() {
		...
		mAddButton.setId(Rconfig.getInstance().id("fab_expand_menu_button"));
  ...
  public void removeButton(FloatingActionButton button) {
    ...
    removeView(button);
    button.setTag(Rconfig.getInstance().id("fab_label"), null);
    mButtonsCount--;
  }
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    for (int i = 0; i < mButtonsCount; i++) {
      ...
      if (!expandsHorizontally()) {
        TextView label = (TextView) child.getTag(Rconfig.getInstance().id("fab_label"));
        if (label != null) {
  ...
  protected void onLayout(boolean changed, int l, int t, int r, int b) {
    ...
    case EXPAND_DOWN:
      ...
      for (int i = mButtonsCount - 1; i >= 0; i--) {
        ...
        View label = (View) child.getTag(Rconfig.getInstance().id("fab_label"));
        if (label != null) {
  ...
  private void createLabels() {
    ...
    for (int i = 0; i < mButtonsCount; i++) {
      ...
      if (button == mAddButton || title == null ||
          button.getTag(Rconfig.getInstance().id("fab_label")) != null) continue;
      ...
      button.setTag(Rconfig.getInstance().id("fab_label"), label);
    }
  }
