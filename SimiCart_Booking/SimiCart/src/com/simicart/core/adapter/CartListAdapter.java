...
public class CartListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (null != mDelegate) {
			rl_quanity
					.setOnClickListener(mDelegate.getClickQtyItem(position,
							cart.getQty(), cart.getMinQtyAllow(),
							cart.getMaxQtyAllow()));
		}
		...
		TextView txt_booking_from = (TextView) convertView.findViewById(Rconfig.getInstance().id("txt_date_from"));
		TextView txt_booking_to = (TextView) convertView.findViewById(Rconfig.getInstance().id("txt_date_to"));
		if(Utils.validateString(cart.getBooking_time_from())){
			txt_booking_from.setText("Booking From :" + cart.getBooking_time_from());
		}else{
			txt_booking_from.setVisibility(View.GONE);
		}
		
		if(Utils.validateString(cart.getBooking_time_to())){
			txt_booking_to.setText("Booking To   :" + cart.getBooking_time_to());
		}else{
