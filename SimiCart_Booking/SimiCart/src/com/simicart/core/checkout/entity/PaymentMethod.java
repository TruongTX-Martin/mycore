...
public class PaymentMethod extends SimiEntity {
	...
	private String mPlaceCCTypeName = "";
	...
	public void setPlace_cc_type_name(String place_cc_type_name) {
		this.mPlaceCCTypeName = place_cc_type_name;
	}

	public String getPlace_cc_type_name() {
		return mPlaceCCTypeName;
	}
