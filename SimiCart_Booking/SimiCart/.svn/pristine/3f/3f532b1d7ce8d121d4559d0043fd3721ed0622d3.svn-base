...
public class SimiManager {
	...
	public void changeStoreView() {
		// Intent intent = new Intent(mCurrentActivity, SplashActivity.class);
		...
		PendingIntent pendingIntent = PendingIntent.getActivity(
				mCurrentActivity, 0, intent, PendingIntent.FLAG_CANCEL_CURRENT);
		AlarmManager manager = (AlarmManager) mCurrentActivity
