...
public class FloatLabel extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int layout;
        int editTextId = Rconfig.getInstance().id("edit_text");
        int floatLabelId = Rconfig.getInstance().id("float_label");
        ...
        if (attrs == null) {
            layout = Rconfig.getInstance().layout("custom_float_label");
            text = null;
            hint = null;
            hintColor = null;
            floatLabelColor = 0;
            ...
            // Main attributes
            layout = a.getResourceId(R.styleable.FloatLabel_android_layout, R.layout.custom_float_label);
