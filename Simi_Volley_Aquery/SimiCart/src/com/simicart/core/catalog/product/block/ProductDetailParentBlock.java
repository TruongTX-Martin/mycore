...
public class ProductDetailParentBlock extends SimiBlock implements
	...
	// customize booking _ 12-02-2016 _ Truongtechno
	private ButtonRectangle btn_booking;
	...
	public void setBookingListenner(OnClickListener listener) {
		btn_booking.setOnClickListener(listener);
	}
	...
	public void initView() {
		...
		// booking
		btn_booking = (ButtonRectangle) mView.findViewById(Rconfig
				.getInstance().id("btn_booking"));
		// = (RelativeLayout)
	...
	private void showBooking() {
		...
		try {
			object.put("booking_quantity", "1000");
			object.put("booking_range_type", "date_fromto");
			object.put("booking_time_from", "11,10,00");
			object.put("booking_time_to", "18,17,00");
			object.put("booking_date_from", "2016-02-04 00:00:00");
			object.put("booking_date_to", "2016-02-28 00:00:00");
		} catch (JSONException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}

		if (mProduct.getCacheBooking() == null) {
			Booking booking = new Booking();
			booking.setJsonObject(object);
			mProduct.setCacheBooking(booking);
		}
		if (mProduct.getCacheBooking() != null) {
			btn_booking.setVisibility(View.VISIBLE);
			btn_booking.setText(Config.getInstance().getText("Booking"));
			btn_booking.setTextColor(Color.parseColor("#FFFFFF"));
			btn_booking.setClickable(true);
			btn_booking.setTextSize(Constants.SIZE_TEXT_BUTTON);
			btn_booking.setBackgroundColor(Config.getInstance().getColorMain());
		} else {
