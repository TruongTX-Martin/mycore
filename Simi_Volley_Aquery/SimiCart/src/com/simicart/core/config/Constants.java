...
public class Constants {
	...
	//customize booking
	public static String BOOKING_QUANTITY = "booking_quantity";
	public static String BOOKING_RANGE_TYPE = "booking_range_type";
	public static String BOOKING_TIME_FROM = "booking_time_from";
	public static String BOOKING_TIME_TO = "booking_time_to";
	public static String BOOKING_DATE_FROM = "booking_date_from";
	public static String BOOKING_DATE_TO = "booking_date_to";
	public static String BOOKING_EXCLUDEDAYS = "booking_excludeddays";
}
