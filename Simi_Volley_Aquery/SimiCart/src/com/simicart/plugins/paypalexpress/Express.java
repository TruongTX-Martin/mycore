...
public class Express {
	...
	public void addButtonPayPalToCart() {
		...
		ButtonRectangle b_checkout = (ButtonRectangle) rootView
				.findViewById(Rconfig.getInstance().id("checkout"));
		lp_express.addRule(RelativeLayout.BELOW, b_checkout.getId());
		lp_express.setMargins(Utils.getValueDp(5), Utils.getValueDp(8),
